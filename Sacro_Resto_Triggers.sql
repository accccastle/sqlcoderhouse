-- EJECUTAR ANTES para normalizar el stock a 0 y que funcione el trigger, sumando. Ya que el valor era nulo y no funcionaba
...
INSERT INTO _users VALUES (null,'acccastle');
INSERT INTO _users VALUES (null,'rocio_rocio');
INSERT INTO _users VALUES (null,'iglesias_rocio');

-- Triggers auditoria para ingreso de venta por ticket
...
-- Trigger auditoria para ingreso de ordernes
...
-- Trigger auditoria para ingreso de compras proveedores
...
-- Trigger auditoria update clients
...
-- Trigger auditoria update employees
...
-- Trigger auditoria update products
...
INSERT INTO orders VALUES (NULL, 1, 20998372, 1, 4);
...
-- Trigger muestra mensaje de error si el importe ingresado en un registro de compras es negativo (-000)

DELIMITER //
CREATE TRIGGER mensaje_error_compra
...
-- Trigger actualizar stock al generar una compra
...
-- Trigger muestra mensaje de error si el importe ingresado en un registro de venta es negativo (-000)

DELIMITER //
CREATE TRIGGER mensaje_error_venta
...
-- Trigger para tabla empleados, guarda el dato en mayuscula
